...
public class UC01_010 extends UC implements UCBuilder, checkAreaBuildings {
    ...
    public void assignmentCode(LmstQuery queryTemplate) {
        ...
        Set<Parcel> parcelListAll = new HashSet<>(queryTemplate.getListParcelsByTags(queryTagForCode(codeOnlyCondition().getTags()), queryExcludeTags(codeOnlyCondition().getExcludeTags()),
