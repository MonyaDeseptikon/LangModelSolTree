package deseptikon.monya.configuration.db.auxiliary;
...
public class ReplaceLatinHandler implements ReplaceLatin {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        List<Parcel> parcelWithoutLatin = new ReplaceLatinHandler().replaceLatinRow(parcelList);
        int codeCount = 0;
        for (Parcel parcel : parcelWithoutLatin) {
        ...
        queryTemplate.updateParcelsForReplaceLatin(parcelWithoutLatin);
