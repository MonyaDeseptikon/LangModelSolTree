...
public class UC01_01New {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        new UC01_01New().codeHandler(queryTemplate);
    ...
    public void codeHandler(LmstQuery queryTemplate){
        ...
        conditionsNew.setShareAreaBuildings(0.05F);
        ...
        conditionsNew.setConditionsNewList(List.of(
                ...
                conditionsNew.new InternalConditions(List.of("растениеводство"),
                        List.of(), 0F, Float.POSITIVE_INFINITY, true, true),
                conditionsNew.new InternalConditions(List.of("пашня"),
                        List.of(), 0F, Float.POSITIVE_INFINITY, true, true),
        ...
        conditionsNew.assignmentCode(queryTemplate);
