package deseptikon.monya.usage_code_new.usage_codes_old;
...
import deseptikon.monya.usage_code_new.usage_codes_old.model.uc.UC;
import deseptikon.monya.usage_code_new.usage_codes_old.model.uc.UCBuilder;
import deseptikon.monya.usage_code_new.usage_codes_old.model.uc.checkAreaBuildings;
...
public class UC01_010 extends UC implements UCBuilder, checkAreaBuildings {
    ...
    public void assignmentCode(LmstQuery queryTemplate) {
        ...
        parcelListAll.forEach(p->p.setUsageCode(usageCode()));
